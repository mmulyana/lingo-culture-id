export const data = [
  ...
  },
  {
    ...
    data: [
      ...
      {
        title: 'ulos sibolang',
        img: '/public/img/ulossibolang.png',
        description: 'Kain ulos digunakan sebagai simbol duka cita dalam budaya masyarakat Batak. Salah satu jenis ulos yang digunakan dalam situasi duka cita adalah Ulos Sibolang. Ulos Sibolang memiliki corak yang saling beriringan yang melambangkan kesuburan dan kekompakan. Ulos ini sering diberikan kepada seorang anak yang baru lahir, terutama anak pertama. Meskipun dulunya dipakai untuk keperluan duka dan sukacita, saat ini Ulos Sibolang dianggap sebagai simbol duka cita yang dipakai oleh keluarga dekat yang kehilangan anggota keluarga, seperti dalam kasus Ulos Saput untuk orang dewasa yang meninggal tetapi belum memiliki cucu, Ulos Tujung untuk janda dan duda, yang artinya mereka yang ditinggal mati oleh pasangan mereka. Penggunaan Ulos Sibolang dalam acara duka menunjukkan kedekatan hubungan dengan orang yang meninggal.',
        is_read: false,
      },
      {
      ...
      },
      {
        ...
        img: '/public/img/ulosragihotang.png',
        description: 'Ulos ragi hotang adalah jenis ulos yang bergaris atau bercorak rotan yang dikenakan pada upacara adat, khususnya pernikahan. Setiap tema luar ruang memiliki makna yang berhubungan dengan kehidupan. Motif hotang melambangkan ikatan antara pasangan untuk pernikahan yang harmonis. ',
        is_read: false,
      },
    ],
  },
  {
    ...
    data: [
      ...
      },
      {
        ...
        img: '/public/img/pattuqduqtowanie.png',
